...
import com.smartjinyu.criminalintent.database.CrimeBaseHelper;
import com.smartjinyu.criminalintent.database.CrimeCursorWrapper;
import com.smartjinyu.criminalintent.database.CrimeDbSchema;
...
public class CrimeLab {
    ...
    private CrimeCursorWrapper queryCrimes(String whereClause, String[] whereArgs){
        Cursor cursor = mDatabase.query(
                CrimeDbSchema.CrimeTable.NAME,//TableName
